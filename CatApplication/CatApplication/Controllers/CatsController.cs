...
namespace CatApplication.Controllers
{
    public class CatsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Breed,ImgUrl")] Cat cat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Breed,ImgUrl")] Cat cat)
        {
            if (id != cat.Id)
            {
                return NotFound();
